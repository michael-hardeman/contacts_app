...
An example web app using the Ada micro service backend. You can use any front end you like.
To develop this particular one you will need nodejs and npm installed.
